...
local_parameters = [{'name': 'camera_name1',        'default': 'onboard_front',          'description': 'camera1 unique name'},
                    {'name': 'camera_name2',        'default': 'onboard_back',          'description': 'camera2 unique name'},
                    ...
                    {'name': 'serial_no1',          'default': '_218622278300', 'description': 'camera1 serial number'},
                    {'name': 'serial_no2',          'default': '_419122270673', 'description': 'camera2 serial number'},
                    ...
                    {'name': 'rgb_camera.color_profile1',     'default': '848,480,90', 'description': 'color stream profile'},
                    {'name': 'rgb_camera.color_format1',      'default': 'BGR8', 'description': 'color stream format'},
                    {'name': 'rgb_camera.enable_auto_exposure1', 'default': 'true', 'description': 'enable/disable auto exposure for color image'},
                    {'name': 'rgb_camera.color_profile2',     'default': '848,480,90', 'description': 'color stream profile'},
                    {'name': 'rgb_camera.color_format2',      'default': 'BGR8', 'description': 'color stream format'},
                    {'name': 'rgb_camera.enable_auto_exposure2', 'default': 'true', 'description': 'enable/disable auto exposure for color image'},
                    {'name': 'depth_module.depth_profile1',   'default': '848,480,90', 'description': 'depth stream profile'},
                    {'name': 'depth_module.depth_format1',    'default': 'Z16', 'description': 'depth stream format'},
                    {'name': 'depth_module.depth_profile2',   'default': '848,480,90', 'description': 'depth stream profile'},
...
def launch_base_footprint_transform_publisher_node(context: LaunchContext):
    front_node = launch_ros.actions.Node(
    ...
    back_node = launch_ros.actions.Node(
